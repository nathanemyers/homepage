"""
Django settings for nathanemyers project.
...
ROOT_URLCONF = 'nathanemyers.urls'
...
WSGI_APPLICATION = 'nathanemyers.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, '/var/www/nathanemyers.com/static')
